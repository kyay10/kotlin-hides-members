...
val pluginDescription =
  "A Kotlin compiler plugin that allows using @HidesMembers with more functions"
val pluginName = "kotlin-hides-members"
val pluginDisplayName = "Kotlin Hides Members compiler plugin"
gradlePlugin {
  plugins {
    create(pluginName) {
      id = "io.github.kyay10.kotlin-hides-members"
      displayName = pluginDisplayName
      description = pluginDescription
      implementationClass = "io.github.kyay10.kotlinhidesmembers.HidesMembersGradlePlugin"
    }
  }
}
pluginBundle {
  website = "https://github.com/kyay10/kotlin-hides-members"
  vcsUrl = website
  description = pluginDescription
