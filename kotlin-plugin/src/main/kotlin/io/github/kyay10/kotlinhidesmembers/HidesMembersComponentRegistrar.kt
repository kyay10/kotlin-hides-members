...
class HidesMembersComponentRegistrar @Suppress("unused") constructor() :
    ComponentRegistrar { // Used by service loader
    override fun registerProjectComponents(
        project: MockProject,
        configuration: CompilerConfiguration
    ) {
        val originalNames = HIDES_MEMBERS_NAME_LIST
        ::HIDES_MEMBERS_NAME_LIST.javaField!!.apply { forceAccessible() }.set(null, UniversalSet(originalNames))
    }
}
